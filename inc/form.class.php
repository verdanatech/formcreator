...
PluginFormcreatorTranslatableInterface
{
   ...
   public function showWizard() : void {
      ...
      echo '<input type="radio" class="form-check-input" id="plugin_formcreator_mostPopular" name="sort" value="mostPopularSort" '.$selected.' onclick="showTiles(tiles)"/>';      echo '<label for="plugin_formcreator_mostPopular">';
      ...
      echo '<input type="radio" class="form-check-input" id="plugin_formcreator_alphabetic" name="sort" value="alphabeticSort" '.$selected.' onclick="showTiles(tiles)"/>';      echo '<label for="plugin_formcreator_alphabetic">';
