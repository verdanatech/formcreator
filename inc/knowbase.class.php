 ...
 * @since 0.84
 **/
class PluginFormcreatorKnowbase extends CommonGLPI
{
    ...
    static function showSearchView()
    {
        ...
        $ki = new PluginFormcreatorKnowbaseItem();
        $ki->searchForm($_GET);


        if (!isset($_GET['contains']) || empty($_GET['contains'])) {
            echo "<div><table class='center-h' width='950px'><tr class='noHover'><td class='center top'>";
            PluginFormcreatorKnowbaseItem::showRecentPopular("recent");
            echo "</td><td class='center top'>";
            PluginFormcreatorKnowbaseItem::showRecentPopular("lastupdate");
            echo "</td><td class='center top'>";
            PluginFormcreatorKnowbaseItem::showRecentPopular("popular");
            echo "</td></tr>";
            echo "</table></div>";
        } else {
            PluginFormcreatorKnowbaseItem::showList($_GET, 'search');
        }
    }
